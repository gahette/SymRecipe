...
class Recipe
{
    ...
    public
    function setTime(?int $time): self
    {
        $this->time = $time;
    ...
    public
    function getNbPeople(): ?int
    {
        return $this->nbPeople;
    }

    public
    function setNbPeople(?int $nbPeople): self
    {
    ...
    public
    function setDifficulty(?int $difficulty): self
    {
    ...
    public
    function isIsFavorite(): ?bool
    {
        return $this->isFavorite;
    }

    public
    function setIsFavorite(bool $isFavorite): self
    {
    ...
    public
    function addIngredient(Ingredient $ingredient): self
    {
    ...
    public
    function removeIngredient(Ingredient $ingredient): self
    {
